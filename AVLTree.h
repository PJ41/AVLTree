...
class AVLTree {
 ...
 private:
  ...
  string pathTo(const string& x, AVLNode * curNode) const;
  bool find(const string& x, AVLNode * curNode) const;
  int numNodes(AVLNode * bn) const;
  int balanceFactor(AVLNode * an);
};
